...
@section('content')
    ...
    <div class="container mt-4">
        <div class="list-view-notes">
            <div id="openModalCard" data-toggle="modal" data-target="#noteFormModal">
    ...
    <div class="modal fade" id="noteFormModal" tabindex="-1" role="dialog" aria-labelledby="noteFormModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content" id="noteForm">
                @csrf
                <input type="hidden" class="note-id" name="note-id" value="">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control text-capitalize" id="title" name="title">
                        <span class="invalid-feedback titleError"></span>
                    </div>
                    <div class="mb-3">
                        <label for="content" class="form-label">Content</label>
                        <textarea type="text" class="form-control text-capitalize" id="content" name="content"></textarea>
